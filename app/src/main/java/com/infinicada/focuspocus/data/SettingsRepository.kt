...
class SettingsRepository(private val prefs: SharedPreferences) {
    ...
    fun setThemeMode(mode: ThemeMode) {
        prefs.edit { putString(Constants.PrefsKeys.THEME_MODE, mode.name) }
    }
    ...
    fun setAnalyticsConsent(enabled: Boolean) {
        prefs.edit { putBoolean(Constants.PrefsKeys.ANALYTICS_CONSENT, enabled) }
    }
    ...
    fun setAnalyticsConsentShown() {
        prefs.edit { putBoolean(Constants.PrefsKeys.ANALYTICS_CONSENT_SHOWN, true) }
    }
    ...
    fun setMuteBlockedNotifications(enabled: Boolean) {
        prefs.edit { putBoolean(Constants.PrefsKeys.MUTE_BLOCKED_NOTIFICATIONS, enabled) }
    }
    ...
    fun setHideStopButton(enabled: Boolean) {
        prefs.edit { putBoolean(Constants.PrefsKeys.HIDE_STOP_BUTTON, enabled) }
    }
    ...
    fun setSealLiftedAlertsEnabled(enabled: Boolean) {
        prefs.edit { putBoolean(Constants.PrefsKeys.SEAL_LIFTED_ALERTS_ENABLED, enabled) }
    }
    ...
    fun setNfcLockMode(enabled: Boolean) {
        prefs.edit { putBoolean(Constants.PrefsKeys.NFC_LOCK_MODE, enabled) }
    }
    ...
    fun setDeviceOwnerEnforcement(enabled: Boolean) {
        prefs.edit { putBoolean(Constants.PrefsKeys.DEVICE_OWNER_ENFORCEMENT, enabled) }
    }
    ...
    fun setDeviceOwnerSuspendPacts(enabled: Boolean) {
        prefs.edit { putBoolean(Constants.PrefsKeys.DEVICE_OWNER_SUSPEND_PACTS, enabled) }
    }
    ...
    fun setWardenRemovalRequestMillis(millis: Long) {
        prefs.edit { putLong(Constants.PrefsKeys.WARDEN_REMOVAL_REQUEST_MILLIS, millis) }
    }

    fun clearWardenRemovalRequest() {
        prefs.edit { remove(Constants.PrefsKeys.WARDEN_REMOVAL_REQUEST_MILLIS) }
    }
    ...
    fun setBreakDurationMinutes(minutes: Int) {
        prefs.edit { putInt(Constants.PrefsKeys.BREAK_DURATION_MINUTES, minutes.coerceIn(1, 30)) }
    }
    ...
    fun setMaxBreaksPerSession(max: Int) {
        prefs.edit { putInt(Constants.PrefsKeys.MAX_BREAKS_PER_SESSION, max.coerceIn(1, 10)) }
    }
    ...
    fun setAutoBreakEnabled(enabled: Boolean) {
        prefs.edit { putBoolean(Constants.PrefsKeys.AUTO_BREAK_ENABLED, enabled) }
    }
    ...
    fun setAutoBreakIntervalMinutes(minutes: Int) {
        prefs.edit { putInt(Constants.PrefsKeys.AUTO_BREAK_INTERVAL_MINUTES, minutes.coerceIn(5, 60)) }
    }
    ...
    fun setEmergencyBreakCadenceWeeks(weeks: Int) {
        prefs.edit { putInt(Constants.PrefsKeys.EMERGENCY_BREAK_CADENCE_WEEKS, weeks.coerceIn(2, 8)) }
    }
    ...
    fun setProgressionEnabled(enabled: Boolean) {
        prefs.edit { putBoolean(Constants.PrefsKeys.PROGRESSION_ENABLED, enabled) }
    }
    ...
    fun setWrapupEnabled(enabled: Boolean) {
        prefs.edit { putBoolean(Constants.PrefsKeys.WRAPUP_ENABLED, enabled) }
    }
    ...
    fun setProgressionIntroShown() {
        prefs.edit { putBoolean(Constants.PrefsKeys.PROGRESSION_INTRO_SHOWN, true) }
    }
    ...
    fun setPactsHomeIntroShown() {
        prefs.edit { putBoolean(Constants.PrefsKeys.PACTS_HOME_INTRO_SHOWN, true) }
    }
}
